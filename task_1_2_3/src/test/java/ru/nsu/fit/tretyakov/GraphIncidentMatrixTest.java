...
public class GraphIncidentMatrixTest {

    @Test
    public void readFromTheFile() throws FileNotFoundException {

        File file = new File("./src/test/java/ru/nsu/fit/tretyakov/GraphIncMatrix.txt");
    ...
    @Test
    public void readFromTheFileUndirected() throws FileNotFoundException {
    ...
    public void graphToVertexArrayTest() {
        ...
        Graph<Integer> testGraph = new GraphIncidentMatrix<Integer>(list, true);
    ...
    public void duplicatedVerticesTest() {
        ...
        Graph<Integer> testGraph = new GraphIncidentMatrix<Integer>(start, true);
    ...
    public void duplicatedEdgesTest() {
        ...
        Edge<Integer> curEdge = new Edge<>(vertices[0], vertices[1]);
        testGraph.addEdge(curEdge);
    ...
    public void multiplyAddingVertices() {
        Graph<Integer> testGraph = new GraphIncidentMatrix<Integer>(new Vertex<>(1), true);
    ...
    public void shortestPathUndirectedGraphTest() {
        Graph<Integer> graph = new GraphIncidentMatrix<>(false);
    ...
    public void shortestPathDirectedGraphTest() {
        ...
        Graph<String> graph = new GraphIncidentMatrix<>(true);
    ...
    @Test
    public void deleteEdgesUndirectedGraph(){
        Graph<String> graph = new GraphIncidentMatrix<>(false);
        ...
        graph.addEdges(edgeList);
        graph.deleteEdge(edgeList.get(2));

        for (var edge: graph.toEdgeArray()){
            assertTrue(edge.getWeight() != 18);
        }
    }
}